...
const IconCheckmail = props =>
  (<object className={`inlineVector ${props.className}`}>
    <svg className="inlineVector__svg" width="58px" height="49px" viewBox="0 0 58 49" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g className="inlineVector__shape" fill={props.fill} id="Page-1" stroke="none" strokeWidth="1" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="check-email" transform="translate(-651.000000, -128.000000)" stroke="#18CEA0" strokeWidth="2">
